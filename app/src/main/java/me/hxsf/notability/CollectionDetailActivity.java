...
//        });
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(CollectionDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(CollectionDetailFragment.ARG_ITEM_ID));
            CollectionDetailFragment fragment = new CollectionDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.collection_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, CollectionListActivity.class));
            return true;
        }
